...
if st.button('Construir Histograma'):
    st.write('Histograma de la variable "year"')
    fig = px.histogram(car_data, x='year',
...
if st.button('Construir Gráfico de Dispersión'):
    st.write('Gráfico de Dispersión de "year" vs "mileage"')
    fig = px.scatter(car_data, x='year', y='mileage',
                     title='Años vs Kilometraje de Vehículos')
    st.plotly_chart(fig)
